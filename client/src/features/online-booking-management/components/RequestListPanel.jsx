            ...
            items.map((req) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-2 px-2 text-gray-600 max-w-[160px] truncate" title={getServiceLabels(req.service_ids)}>
                    {getServiceLabels(req.service_ids)}
                  </td>
                  <td className="py-2 px-2 text-gray-600">
                    {formatDateOnly(req.preferred_date)}
                    <br />
                    <span className="text-[10px] text-gray-400">{getTimeSlotLabel(req.preferred_time_slot_id)}</span>
                  </td>
